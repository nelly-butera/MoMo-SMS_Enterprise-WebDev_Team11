...
### Project Overview
This project is an enterprise-level fullstack application designed to process, clean, analyze, and visualize Mobile Money (MoMo) SMS transaction data provided in XML format.
...
This repository represents **Week 1 – Team Setup & Project Planning**, focusing on repository setup, system architecture design, and Scrum workflow organization.
...
- [x] README with team info and links
- [x] Architecture diagram committed
- [x] Scrum board created and populated


### Note
This repository will evolve weekly as new features are added.
